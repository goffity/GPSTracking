...
// in simulator we redefine to format for GPSTracking Developer console
...
{\
	NSString * exceptionName = [@"org.gpstracking." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gpstracking";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGPSTrackingNativeItemNone = -1, 
	UIGPSTrackingNativeItemSpinner = -2,
	UIGPSTrackingNativeItemProgressBar = -3,
	
	UIGPSTrackingNativeItemSlider = -4,
	UIGPSTrackingNativeItemSwitch = -5,
	UIGPSTrackingNativeItemMultiButton = -6,
	UIGPSTrackingNativeItemSegmented = -7,
	
	UIGPSTrackingNativeItemTextView = -8,
	UIGPSTrackingNativeItemTextField = -9,
	UIGPSTrackingNativeItemSearchBar = -10,
	
	UIGPSTrackingNativeItemPicker = -11,
	UIGPSTrackingNativeItemDatePicker = -12,
	
	UIGPSTrackingNativeItemInfoLight = -13,
	UIGPSTrackingNativeItemInfoDark = -14,
	
	UIGPSTrackingNativeItemDisclosure = -15,
	
	UIGPSTrackingNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GPSTracking instances of
