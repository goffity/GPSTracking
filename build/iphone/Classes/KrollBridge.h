...
@interface GPSTrackingObject : KrollCoverageObject {
#else
@interface GPSTrackingObject : KrollObject {
#endif
@private
...
extern NSString * GPSTracking$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GPSTrackingObject *_gpstracking;
    KrollObject* console;
	BOOL shutdown;
