...
/**
 Base class for all GPSTracking views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GPSTracking view hierarchy (such as wrapped iOS UIViews) was touched.
