 ...
 * Copyright (c) 2009-2011 by GPSTracking, Inc. All Rights Reserved.
...
//@interface GPSTrackingObject : NSObject
//@end

@interface GPSTrackingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GPSTrackingObject class]])
		{
			for (NSString *key in [[(GPSTrackingObject*)o modules] allKeys])
			{
